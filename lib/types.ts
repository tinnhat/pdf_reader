...
export interface Note {
  ...
  page?: number;
  /** Rich-text HTML content written by the reader. */
  content: string;
  /**
   * Plain text fallback extracted from the rich content. Useful for previews or
   * backwards compatibility with earlier versions of the UI.
   */
  plainText?: string;
  /** @deprecated Legacy text field kept for compatibility with existing data. */
  text?: string;
  createdAt: string;
}
